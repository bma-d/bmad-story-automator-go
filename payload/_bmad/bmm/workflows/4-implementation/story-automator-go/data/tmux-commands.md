...
Script: `{project_root}/_bmad/bmm/workflows/4-implementation/story-automator-go/bin/story-automator tmux-status-check`

```bash
# ALWAYS use absolute path - relative paths break when directory changes
{project_root}/_bmad/bmm/workflows/4-implementation/story-automator-go/bin/story-automator tmux-status-check "SESSION_NAME"
```
